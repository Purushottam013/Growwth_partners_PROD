      ...
      <div className="container mx-auto px-4">
        <div className="max-w-8xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-slate-50 to-orange-50/50 rounded-3xl p-8 md:p-12 mb-12 border border-slate-100 text-center"
          >
            <p className="text-lg md:text-xl text-slate-700 leading-relaxed mb-6 max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-8xl mx-auto">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="h-full p-6 bg-white rounded-2xl border shadow border-slate-200 hover:border-orange-300 hover:shadow-lg hover:shadow-orange-100/50 transition-all duration-300">
