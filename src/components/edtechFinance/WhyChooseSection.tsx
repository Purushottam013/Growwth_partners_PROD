...
const reasons = [
  {
    icon: GraduationCap,
    title: "Experience supporting EdTech, learning platforms, and education startups",
  },
  {
    icon: MapPin,
    title: "Strong understanding of Singapore's EdTech and startup ecosystem",
  },
  {
    icon: Users,
    title: "CFO-led approach focused on unit economics and sustainability",
  },
  {
    icon: Cpu,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-4">
            Why Choose Growwth Partners for EdTech Finance?
          </h2>
        </motion.div>
        ...
        >
          <div className="inline-block p-8 bg-gradient-to-r from-brand-orange/10 to-amber-500/10 rounded-3xl border border-brand-orange/20">
            <p className="text-xl text-gray-900 font-semibold">
              We help EdTech founders move from enrolment growth to profitable education delivery.
            </p>
          </div>
        </motion.div>
      </div>
