      ...
      <div className="container-custom">
        <div className="relative bg-gradient-to-r from-brand-orange/10 to-amber-500/10 rounded-3xl p-10 sm:p-16 shadow-lg overflow-hidden">
          ...
          >
            ...
            >
              Build Sustainable, Investor-Ready Financials for Your EdTech Business
            </motion.h2>
            <motion.p
              initial={{ opacity: 0 }}
            ...
            >
              Get expert EdTech finance leadership to support your unit economics, growth, and funding goals.
            </motion.p>
            ...
            >
              ...
              >
                👉 Schedule an EdTech Finance Consultation
