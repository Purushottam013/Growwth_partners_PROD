        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-6">
              Who Should Use{" "}
              <span className="text-orange-600 dark:text-orange-400">VC & Fund Finance Services?</span>
            </h2>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              {idealFor.map((item, index) => (
                <motion.div
                  ...
                  className="flex items-center gap-4 p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 hover:border-orange-300 dark:hover:border-orange-600 transition-colors"
                >
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="p-8 rounded-3xl bg-gradient-to-br from-slate-900 to-orange-950 dark:from-slate-800 dark:to-orange-900 text-white h-full">
                ...
                <div className="space-y-6 mb-8">
                  {questions.map((question, index) => (
                    <div key={index} className="flex items-start gap-3">
                      ...
                      <p className="text-orange-100 text-lg">{question}</p>
                    </div>
                  ))}
                </div>
