    ...
    <section className="py-20 md:py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-orange-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Get Accurate, Audit-Ready Books{" "}
          ...
          >
            Get reliable, professional bookkeeping that scales with your business needs.
          </motion.p>
          ...
          >
            ...
            >
              Schedule an Outsourced Bookkeeping Consultation
