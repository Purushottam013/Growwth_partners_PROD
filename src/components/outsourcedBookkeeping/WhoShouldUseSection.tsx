...
import { Check, Rocket, TrendingUp, User, Building2, Globe, AlertCircle } from "lucide-react";

const idealFor = [
  {
    icon: Rocket,
    text: "Startups and SMEs without internal accounting teams"
  },
  {
    icon: TrendingUp,
    text: "Growing businesses with increasing transaction volumes"
  },
  {
    icon: User,
    text: "Founders spending too much time on finance operations"
  },
  {
    icon: Building2,
    text: "Companies preparing for audits, fundraising, or expansion"
  },
  {
    icon: Globe,
    text: "International businesses operating in Singapore"
  }
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-8">
              Outsourced Bookkeeping services are ideal for businesses seeking accurate, reliable financial records without building an in-house accounting team.
            </p>
          ...
          >
            <div className="bg-gradient-to-br from-brand-orange/10 via-orange-50 to-amber-50 rounded-3xl p-8 md:p-10 shadow">
              ...
              <p className="text-gray-700 mb-6">
                If your books are often delayed, require repeated corrections, or fail audits or reviews, outsourced bookkeeping provides immediate stability:
              </p>

              <div className="space-y-4">
                {[
                  "Books are delayed or incomplete",
                  "Repeated corrections needed after close",
                  "Failed or difficult audits and reviews",
                  "Limited visibility into cash flow",
                  "Investors questioning financial accuracy"
                ].map((sign, index) => (
