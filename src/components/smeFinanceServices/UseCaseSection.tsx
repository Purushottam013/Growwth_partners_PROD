          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-slate-900 to-slate-800 p-6 md:p-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">Services SME</h3>
            ...
            <div className="grid md:grid-cols-3 gap-0 divide-y md:divide-y-0 md:divide-x divide-gray-100">
              ...
              <div className="p-6 md:p-8 bg-gradient-to-br from-yellow-50 to-yellow-50">
                ...
                <ul className="space-y-3">
                  {[
                    "Implemented budgeting and forecasting frameworks",
                    "Introduced rolling cash flow monitoring",
                    "Built management dashboards"
                  ].map((item, idx) => (
                    <li key={idx} className="flex items-start gap-2 text-gray-600">
              ...
              <div className="p-6 md:p-8 bg-gradient-to-br from-green-50 to-emerald-50">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Better cost control",
                    "Increased confidence in expansion decisions"
                  ].map((item, idx) => (
