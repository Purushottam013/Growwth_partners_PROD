      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-slate-600">
            Fintech Finance services deliver specialised financial management
            designed for technology-enabled financial services businesses. Unlike
            general tech finance, fintech finance requires deep alignment with
            regulatory frameworks, financial controls, and audit standards.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-8xl mx-auto mb-10">
          {features.slice(0, 3).map((feature, index) => (
            <motion.div
              ...
              className="group p-6 bg-gradient-to-br from-slate-50 to-orange-50/50 rounded-2xl border border-slate-100 shadow hover:border-orange-200 hover:shadow-lg hover:shadow-orange-100/50 transition-all duration-300"
            >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6 max-w-6xl mx-auto">
          {features.slice(3).map((feature, index) => (
            <motion.div
              ...
              className="group w-full max-w-md p-6 bg-gradient-to-br from-slate-50 to-orange-50/50 rounded-2xl border border-slate-100 shadow hover:border-orange-200 hover:shadow-lg hover:shadow-orange-100/50 transition-all duration-300"
            >
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <feature.icon className="w-6 h-6 text-white" />
              </div>
