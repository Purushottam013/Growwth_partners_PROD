      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto font-medium">
            Trusted by startups and scale-ups across Australia, New Zealand, Southeast Asia, and India. Founders and finance leaders choose Growwth Partners for clear structures, smooth implementation, and ongoing support.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <CarouselPrevious className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 border-teal-200 hover:bg-teal-50" />
            <CarouselNext className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 border-teal-200 hover:bg-teal-50" />
          </Carousel>
        </motion.div>
      </div>
    </section>
