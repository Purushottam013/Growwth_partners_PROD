...
const HeroSection = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-growwth-dark">
      {/* Gradient Orbs */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-orange-500/10 border border-orange-400/30 rounded-full mb-8 backdrop-blur-sm">
            ...
            <span className="text-orange-300 text-sm font-semibold tracking-wide">Crisis-Ready CFO Leadership</span>
          </div>

          {/* Main Heading */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-8 leading-[1.1]">
            <span className="text-white">Interim CFO Services in</span>
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-amber-400 to-growwth-primary">
              Singapore
            </span>
          </h1>
