        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {reasons.map((reason, index) => (
              <div 
                key={index}
                className="group relative bg-gradient-to-br from-slate-50 to-amber-50/50 rounded-2xl p-8 hover:shadow-xl transition-all duration-500 border border-slate-100"
              >
