          ...
          <div className="mt-8 max-w-3xl mx-auto">
            <div className="bg-slate-900 rounded-2xl p-8 text-center shadow">
              <p className="text-lg text-slate-300 leading-relaxed">
                Unlike traditional accounting services that focus on compliance, SME CFO services focus on <span className="text-orange-400 font-semibold">forward-looking financial control</span> and <span className="text-amber-400 font-semibold">business performance</span>.
              </p>
            </div>
          </div>
        </div>
