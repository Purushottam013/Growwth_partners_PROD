        ...
        <div className="max-w-8xl mx-auto text-center">
          ...
          >
            <span className="inline-block px-4 py-2 mb-6 text-sm font-medium text-orange-400 bg-orange-500/10 rounded-full border border-orange-500/20">
              Compliance-Ready Finance for Crypto & Web3 Companies
            </span>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Crypto & Web3 Finance Services in{" "}
            ...
            {[
              {
                ...
                desc: "Expert classification & tracking",
              },
              {
                icon: Clock,
                label: "Real-time Visibility",
                desc: "Treasury dashboards",
              },
              {
                icon: Shield,
                label: "Compliance Ready",
                desc: "Investor & regulator aligned",
              },
            ].map((item, index) => (
              <div
                key={index}
