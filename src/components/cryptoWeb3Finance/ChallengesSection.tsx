...
>
  <div className="p-8 bg-gradient-to-br from-green-500/10 to-transparent rounded-2xl border border-green-500/20">
    <div className="flex items-center gap-3 mb-6">
    ...
    <div className="space-y-4">
      {benefits.map((benefit, index) => (
        <motion.div
          ...
          className="flex items-center gap-4 p-4 bg-slate-800/50 rounded-xl border border-slate-700"
        >
          <benefit.icon className="h-5 w-5 text-green-400 shrink-0" />
