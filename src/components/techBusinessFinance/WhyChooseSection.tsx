...
const reasons = [
  {
    ...
    description: "Experience across SaaS, platforms, marketplaces, and product-led companies"
  },
  {
    icon: Globe,
    title: "Singapore Ecosystem",
    description: "Strong understanding of Singapore's technology ecosystem and regulatory environment"
  },
  {
    icon: Users,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-amber-500 text-white px-6 py-3 rounded-full">
            ...
            <span className="font-semibold">We help tech companies move from fast growth to controlled, scalable growth.</span>
          </div>
        </motion.div>
      </div>
    </section>
