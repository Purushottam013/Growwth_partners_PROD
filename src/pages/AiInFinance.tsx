...
const AiInFinancePage = () => {
  ...
  "@graph": [
    {
      "@type": "FAQPage",
      "@id": "https://growwthpartners.com/ai-finance/#faq",
      ...
      "url": "https://growwthpartners.com/ai-finance",
      "mainEntity": [
        {
          "@type": "Question",
    ...
    {
      "@type": "Service",
      "@id": "https://growwthpartners.com/ai-finance/#service",
      "name": "AI Finance Automation",
      "description": "AI-powered finance automation tools for forecasting, cash flow visibility, reporting, and decision support.",
