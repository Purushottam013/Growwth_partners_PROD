        ...
        <div className="min-h-[70vh] flex items-center justify-center flex-col text-center px-4 py-12">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8">
              We bring deep local UAE accounting experience, from VAT to company
              incorporations, for scaling local companies and foreign investors
              alike.{" "}
              <strong>
                Your trusted financial base for business growth in Dubai, Abu
                Dhabi, and beyond.
              </strong>
            </p>
            ...
            <div className="relative py-10 px-8 rounded-xl border-2 border-dashed border-orange-300 bg-orange-50/50 mb-10">
              ...
              <p className="text-gray-600">
                Our UAE-exclusive services launch shortly! Register your
                interest to get early access and be the first to benefit from
                local UAE financial innovation.
              </p>
            </div>
