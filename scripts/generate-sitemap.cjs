...
const staticRoutes = [
  ...
  { path: '/au/contact', priority: '0.8', changefreq: 'weekly' },
  { path: '/au/accounting-services-in-australia', priority: '0.8', changefreq: 'weekly' },
  { path: '/au/bookkeeping-services-in-australia', priority: '0.8', changefreq: 'weekly' },
  { path: '/au/payroll-services-in-australia', priority: '0.8', changefreq: 'weekly' },
  { path: '/au/cash-flow-services-in-australia', priority: '0.8', changefreq: 'weekly' },
  { path: '/au/company-incorporation-services-in-australia', priority: '0.8', changefreq: 'weekly' },
  { path: '/au/corporate-secretary-services-in-australia', priority: '0.8', changefreq: 'weekly' },
  { path: '/au/part-time-cfo-australia', priority: '0.8', changefreq: 'weekly' },
